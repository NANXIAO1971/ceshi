...
function cgsddr(timeout = 0) {
  return new Promise((resolve) => {
    headers1 = {
      ...
      'Content-Length': '120',
      'Host': 'mall.cgsd163.com',
      'Connection': 'Keep-Alive',
      'Accept-Encoding': 'gzip',
      'User-Agent': 'okhttp/4.2.2',
    }
let url = {
        url : `http://mall.cgsd163.com/user-service/login/v1/userLoginPassword`,
        headers : headers1,
        body : `${ckck}`,}
...
let url = {
        url : `http://mall.cgsd163.com/api/user/loginin`,
        headers : headers2,
        body : `{"uid":"${userid}"}`,}
      $.post(url, async (err, resp, data) => {
        try {
...
let url = {
        url : `http://mall.cgsd163.com/api/v1/task/awardUserFlower`,
        headers : headers33,
        body : `${sp1}`,}
      $.post(url, async (err, resp, data) => {
        try {
...
function cgsdxx(timeout = 0) {
  return new Promise((resolve) => {
let url = {
        url : `http://mall.cgsd163.com/user-service/flower/v1/getUserFlowerAccount`,
        headers : headers33,
        body :  `{"uid":"${userid}"}`,}
      $.post(url, async (err, resp, data) => {
        try {
